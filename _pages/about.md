...
- `[C] Elsevier SMC-IoT` Yi Wu, Yuyang Pan, Jie Wang, Lihong Nai, <span style="color:blue">**Le Wu**</span>, "Modeling and Application of High-Stability, High-Performance Multi-Data Transceiver Mechanisms: A Case Study on Optimizing Signal Acquisition System Performance for Hardware Security," in the 4th International Conference on Sensing, Measurement, Communication and Internet of Things Technologies (SMC-IoT 2025)
